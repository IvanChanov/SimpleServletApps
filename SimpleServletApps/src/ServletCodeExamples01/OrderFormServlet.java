...
public class OrderFormServlet extends HttpServlet {
    ...
    private static final String TITLE = "Simple Order Form";
    ...
    public void doGet(HttpServletRequest request,
        ...
        writer.println("<td><input type='radio' " +
                "name='deliveryMethod'"
                + " value='One Day Shipping'/>One day Shipping");
        writer.println("<input type='radio' " +
                "name='deliveryMethod' "
                + "value='Two days Shipping'/>Two days Shipping</td>");
        writer.println("</tr>");
        writer.println("<tr>");
        ...
        writer.println("</tr>");
        writer.println("<tr>");
        writer.println("<td>Additional Comments:</td>");
        writer.println("<td><textarea name='instruction' "
                + "cols='40' rows='5'></textarea></td>");
        writer.println("</tr>");
        writer.println("<tr>");
    ...
    public void doPost(HttpServletRequest request,
        ...
        writer.println("Summarized information : <br/>");
